...
Можно действовать наивно по аналогии с классическим случаем, написать
производящую функцию для числа расскрасок. Такая формула рассматривалась (в
контексте теории представлений группы $S_n \wr G$) в работе
...
\end{split}
\end{equation}
Откуда можно сделать предположение, что $\dBB \circ \dA = \dAA$.
...
\subsection{Применение цикленного индекса к решению задач о расскрасках}
\begin{problem}
