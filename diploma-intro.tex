...
структура типа $G$>>. Например, любой вид $F$ можно разложить в такую сумму $F =
...
типа $G$. Например, $\mathbb E \times \mathbb E_1$ это множество с выделенной
точкой, а $\mathbb C^2$ это (упорядоченная) пара циклов.
