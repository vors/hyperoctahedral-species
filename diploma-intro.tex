...
раскрашенных в цвета из $A$. Будем называть их \emph{$A$-раскрашенными}
структурами.
\end{remark}
...
\end{theorem}
\begin{proof}
Рассмотрим $\mathcal F(\mathcal G(A))$. Согласно замечанию \ref{rem:color},
это множество $G(A)$-раскрашенных структур типа $F$. То есть, расскрашенных в
цвета из множества: <<$A$-раскрашенные структуры типа $G$>>.

С другой стороны, рассмотрим аналитический функтор $\mathcal X$ отвечающий
species $F \circ G$. Множество $\mathcal X(A)$ --- это набор $A$-раскрашенных
структур типа $F \circ G$. Их, по определению, можно рассмотреть как
множество $F$-структур, введеных на $A$-раскрашенных $G$-структурах (как новых
точках). А это то же самое, что и $G(A)$-раскрашенные структуры типа $F$. 

Более строгое доказательство см. в \cite{travis} (Lemma 2.5).
\end{proof}
...
%Надо только проверить функториальность
