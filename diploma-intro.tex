...
\cite{Durov}. В этой работе Дурова этот фнктор обозначает $\Phi_A$.
...
для покрашенных (в смысле замечания \ref{rem:color}) структур. Для этого
устроить из моноидальной категории (категории с тензорным произведением) в какую-нибудь алгебру функций. Мы вводим весовую
функцию таким образом чтобы орбита раскрашенной структуры под действием $S_n$
имеет один и тот же вес.
После этого можно задать вопрос о коэффициенте при мономе соответствующего веса.
Это будет число орбит с заданной весовой функцией. В качестве
...
$\sigma$ --- перестановка цикленного типа $\lambda$.
...
Где $z_\lambda$ --- индекс класса сопряженности $\sigma$.
\end{statement}
\begin{proof}
По Лемме Бернсайда это то же
...
во-вторых расскраска должна переходить в себя
\end{proof}
